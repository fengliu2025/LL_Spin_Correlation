...
void Background_Subtraction(){
   ...
   str_pair_type.push_back("#Lambda");
   ...
   std::string output="Background_Subtraction/pt2_Bin_4_FullRange_LLbar";
   //-------------------------------------
   //lambda lambda_bar 0.5- 5.0 0.5-5.0 full range 
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[4][2],h2D_USL_LS_MassDist[4][2],SwapAxesManually(h2D_USLbar_LS_MassDist[4][2]),h2D_LS_LS_MassDist[4][2],pl[2],plbar[2],str_pair_type,str_pt_bin, str_range_bin,output);
    //-------------------------------------

    //-------------------------------------
   str_range_bin = "Short Range";
   output="Background_Subtraction/pt2_Bin_4_ShortRange_LLbar";
   //lambda lambda_bar 0.5- 5.0 0.5-5.0 short range 
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[4][0],h2D_USL_LS_MassDist[4][0],SwapAxesManually(h2D_USLbar_LS_MassDist[4][0]),h2D_LS_LS_MassDist[4][0],pl[2],plbar[2],str_pair_type,str_pt_bin, str_range_bin,output);
    //-------------------------------------


    //-------------------------------------
   str_range_bin = "Long Range";
   output="Background_Subtraction/pt2_Bin_4_LongRange_LLbar";
   //lambda lambda_bar 0.5- 5.0 0.5-5.0 long range 
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[4][1],h2D_USL_LS_MassDist[4][1],SwapAxesManually(h2D_USLbar_LS_MassDist[4][1]),h2D_LS_LS_MassDist[4][1],pl[2],plbar[2],str_pair_type,str_pt_bin, str_range_bin,output);
    //-------------------------------------
   ...
   output="Background_Subtraction/pt2_Bin_0_FullRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[0][2],h2D_USL_LS_MassDist[0][2],SwapAxesManually(h2D_USLbar_LS_MassDist[0][2]),h2D_LS_LS_MassDist[0][2],pl[0],plbar[0],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 0.5- 1.5 0.5-1.5 short range 
   str_range_bin = "Short Range";
   output="Background_Subtraction/pt2_Bin_0_ShortRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[0][0],h2D_USL_LS_MassDist[0][0],SwapAxesManually(h2D_USLbar_LS_MassDist[0][0]),h2D_LS_LS_MassDist[0][0],pl[0],plbar[0],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 0.5- 1.5 0.5-1.5 long range 
   str_range_bin = "Long Range";
   output="Background_Subtraction/pt2_Bin_0_LongRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[0][1],h2D_USL_LS_MassDist[0][1],SwapAxesManually(h2D_USLbar_LS_MassDist[0][1]),h2D_LS_LS_MassDist[0][1],pl[0],plbar[0],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------
   ...
   output="Background_Subtraction/pt2_Bin_3_FullRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[3][2],h2D_USL_LS_MassDist[3][2],SwapAxesManually(h2D_USLbar_LS_MassDist[3][2]),h2D_LS_LS_MassDist[3][2],pl[1],plbar[1],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 1.5- 5.0 1.5-5.0 short range 
   str_range_bin = "Short Range";
   output="Background_Subtraction/pt2_Bin_3_ShortRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[3][0],h2D_USL_LS_MassDist[3][0],SwapAxesManually(h2D_USLbar_LS_MassDist[3][0]),h2D_LS_LS_MassDist[3][0],pl[1],plbar[1],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 1.5- 5.0 1.5-5.0 long range 
   str_range_bin = "Long Range";
   output="Background_Subtraction/pt2_Bin_3_LongRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[3][1],h2D_USL_LS_MassDist[3][1],SwapAxesManually(h2D_USLbar_LS_MassDist[3][1]),h2D_LS_LS_MassDist[3][1],pl[1],plbar[1],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------
   ...
   str_pt_bin[0] = "0.5 < p_{1,t} < 1.5 GeV/c";
   str_pt_bin[1] = "1.5 < p_{2,t} < 5.0 GeV/c";
   output="Background_Subtraction/pt2_Bin_1_FullRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[1][2],h2D_USL_LS_MassDist[1][2],SwapAxesManually(h2D_USLbar_LS_MassDist[2][2]),h2D_LS_LS_MassDist[1][2],pl[0],plbar[1],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 1.5- 5.0 1.5-5.0 short range 
   str_range_bin = "Short Range";
   output="Background_Subtraction/pt2_Bin_1_ShortRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[1][0],h2D_USL_LS_MassDist[1][0],SwapAxesManually(h2D_USLbar_LS_MassDist[2][0]),h2D_LS_LS_MassDist[1][0],pl[0],plbar[1],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 1.5- 5.0 1.5-5.0 long range 
   str_range_bin = "Long Range";
   output="Background_Subtraction/pt2_Bin_1_LongRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[1][1],h2D_USL_LS_MassDist[1][1],SwapAxesManually(h2D_USLbar_LS_MassDist[2][1]),h2D_LS_LS_MassDist[1][1],pl[0],plbar[1],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------
   ...
   str_pt_bin[0] = "1.5 < p_{1,t} < 5.0 GeV/c";
   str_pt_bin[1] = "0.5 < p_{2,t} < 1.5 GeV/c";
   output="Background_Subtraction/pt2_Bin_2_FullRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[2][2],h2D_USL_LS_MassDist[2][2],SwapAxesManually(h2D_USLbar_LS_MassDist[1][2]),h2D_LS_LS_MassDist[2][2],pl[1],plbar[0],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 1.5- 5.0 1.5-5.0 short range 
   str_range_bin = "Short Range";
   output="Background_Subtraction/pt2_Bin_2_ShortRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[2][0],h2D_USL_LS_MassDist[2][0],SwapAxesManually(h2D_USLbar_LS_MassDist[1][0]),h2D_LS_LS_MassDist[2][0],pl[1],plbar[0],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------

   //-------------------------------------
   //lambda lambda_bar 1.5- 5.0 1.5-5.0 long range 
   str_range_bin = "Long Range";
   output="Background_Subtraction/pt2_Bin_2_LongRange_LLbar";
   Background_Subtraction_2D(h2D_USL_USLbar_MassDist[2][1],h2D_USL_LS_MassDist[2][1],SwapAxesManually(h2D_USLbar_LS_MassDist[1][1]),h2D_LS_LS_MassDist[2][1],pl[1],plbar[0],str_pair_type,str_pt_bin, str_range_bin,output);
   //-------------------------------------
